...
const VideoCard = ({ info, searchResult }) => {
  ...
  return (
    ...
    <Link
      ...
      className={`p-2   shadow-lg overflow-hidden rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-all delay-100 ${searchResult?"flex w-full h-[250px] mt-4 gap-[10%]":"w-76 h-[310px]"}`}
    >
      ...
      <h1 className={`font-bold text-lg ${!searchResult &&"truncate"}`}>{title}</h1>
